...
Shape.o:
	g++ -g -I ${lib_netpbm_header} -c src/Shape.cpp -o build/Shape.o

World.o:
	g++ -g -I ${lib_netpbm_header} -c src/World.cpp -o build/World.o
...
game: Main.o Surface.o Surface2d.o Surface3d.o Renderer.o Renderer2d.o Renderer3d.o World.o Shape.o Input.o
	g++ -g -L ${lib_netpbm_library} -o release/game build/Main.o build/Surface.o build/Surface2d.o build/Surface3d.o build/Renderer.o build/Renderer2d.o build/Renderer3d.o build/World.o build/Shape.o build/Input.o -lSDL2 -lGL -lGLEW -Wl,-rpath="./" -lnetpbm
