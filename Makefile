...
Surface.o: src/Surface.cpp
	g++ -c src/Surface.cpp -o build/Surface.o

Surface2d.o: src/Surface2d.cpp
	g++ -c src/Surface2d.cpp -o build/Surface2d.o

Surface3d.o: src/Surface3d.cpp
	g++ -c src/Surface3d.cpp -o build/Surface3d.o

Renderer.o: src/Renderer.cpp
	g++ -c src/Renderer.cpp -o build/Renderer.o

Renderer2d.o: src/Renderer2d.cpp
	g++ -c src/Renderer2d.cpp -o build/Renderer2d.o

Renderer3d.o: src/Renderer3d.cpp
	g++ -c src/Renderer3d.cpp -o build/Renderer3d.o

Input.o:
	g++ -c src/Input.cpp -o build/Input.o

Shape.o:
	g++ -c src/Shape.cpp -o build/Shape.o
